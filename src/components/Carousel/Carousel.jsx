...
const Carousel = () => {
    // const cards = [
    //     {
    //         img: 'https://cdn.wbgames.com/media/526/conversions/thumb_hover_1645571329-sized.jpg',
    //         img_hov: 'https://cdn.wbgames.com/media/526/conversions/thumb_hover_1645571329-sized.jpg',
    //         title: 'Hogwarts Legacy'
    //     },
    //     {
    //         img: 'https://cdn.wbgames.com/media/481/conversions/thumb_1642729421-sized.jpg',
    //         img_hov: 'https://cdn.wbgames.com/media/480/conversions/thumb_hover_1642729133-sized.jpg',
    //         title: 'MultiVersus'
    //     },
    //     {
    //         img: 'https://cdn.wbgames.com/media/493/conversions/thumb_1643410131-sized.jpg',
    //         img_hov: 'https://cdn.wbgames.com/media/494/conversions/thumb_hover_1643410141-sized.jpg',
    //         title: 'LEGO® Star Wars™: The Skywalker Saga'
    //     },
    //     {
    //         img: 'https://cdn.wbgames.com/media/502/conversions/thumb_1644443888-sized.jpg',
    //         img_hov: 'https://cdn.wbgames.com/media/503/conversions/thumb_hover_1644443896-sized.jpg',
    //         title: 'Harry Potter: Magic Awakened'
    //     },
    //     {
    //         img: 'https://cdn.wbgames.com/media/475/conversions/thumb_1637270808-sized.jpg',
    //         img_hov: 'https://cdn.wbgames.com/media/476/conversions/thumb_hover_1637270827-sized.jpg',
    //         title: 'Back 4 Blood'
    //     }
    // ]
        ...
        <div className="cont_items">
            <div className="home_cards" >
                ...
                <div className='cards_item'>
                    ...
                    {/* <img src="https://cdn.wbgames.com/media/480/conversions/thumb_hover_1642729133-sized.jpg"/> */}
                    <p>MultiVersus</p>
                    <div className="icons"></div>
                </div>
                <div className='cards_item'>
                    <img src="https://cdn.wbgames.com/media/493/conversions/thumb_1643410131-sized.jpg"/>
                    {/* <img src="https://cdn.wbgames.com/media/494/conversions/thumb_hover_1643410141-sized.jpg"/> */}
                    <p>LEGO® Star Wars™: The Skywalker Saga</p>
                    <div className="icons"></div>
                </div>
                <div className='cards_item'>
                    <img src="https://cdn.wbgames.com/media/502/conversions/thumb_1644443888-sized.jpg"/>
                    {/* <img src="https://cdn.wbgames.com/media/503/conversions/thumb_hover_1644443896-sized.jpg"/> */}
                    <p>Harry Potter: Magic Awakened</p>
                    <div className="icons"></div>
                </div>
                <div className='cards_item'>
                    <img src="https://cdn.wbgames.com/media/475/conversions/thumb_1637270808-sized.jpg"/>
                    {/* <img src="https://cdn.wbgames.com/media/476/conversions/thumb_hover_1637270827-sized.jpg"/> */}
                    <p>Back 4 Blood</p>
                    <div className="icons"></div>
                </div>
            </div>
            ...
            <div className="block_toUpd_cont">
                <div className="box_toUpdate">
                    <h3><i>BE THE FIRST TO <br />KNOW</i></h3>
                    <p>Sign up and never miss an update.</p>
                    <button>STAY CONNECTED</button>
                </div>
                <img src="https://cdn.wbgames.com/static/wb-play-slide-1.jpg" alt="be the first to know" />
            </div>
            <div id="border"></div>
            </div>
