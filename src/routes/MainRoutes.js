...
import EditPage from "../pages/AdminEditPage/EditPage";
...
const MainRoutes = () => {
  ...
  const PUBLIC_ROUTES = [
    ...
    { link: "/game", element: <GamePage />, id: 2 },
    { link: "/details/:id", element: <ProductDetails />, id: 3 },
  ...
  const PRIVATE_ROUTES = [
    ...
    { link: "/edit", element: <EditPage />, id: 2 },
  ];
