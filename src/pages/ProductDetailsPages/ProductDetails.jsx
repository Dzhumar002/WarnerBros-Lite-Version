    ...
    <div id="details__container">
      ...
      <div className="content__container">
        <div className="left__side">
          ...
          <a
            ...
            href="https://play.google.com/store/apps/details?id=com.wb.goog.injustice.brawler2017&hl=en_US"
          >
            <svg
          ...
          <a
            className="playstore-button"
            href="https://itunes.apple.com/us/app/injustice-2/id1109008423?mt=8"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
      ...
      <div className="botton__content">
        ...
        <div className="conversation">
          ...
          <div className="card__conversation">
            <a
